...
export function ChartFromJSONTyped(json: any, ignoreDiscriminator: boolean): Chart {
    ...
    return {
        ...
        'submittedOn': !exists(json, 'submittedOn') ? undefined : (new Date(json['submittedOn'])),
    };
}
...
export function ChartToJSON(value?: Chart | null): any {
    ...
    return {
        ...
        'submittedOn': value.submittedOn === undefined ? undefined : (value.submittedOn.toISOString()),
    };
}
